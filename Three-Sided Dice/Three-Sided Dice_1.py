...
def EulerKineMaticaleQuationsTransform(uid,o2):  #将惯性坐标系的角速度通过欧拉运动方程转化为非惯性参考系的角速度。
...
pb.resetDebugVisualizerCamera(cameraDistance=10,cameraYaw=110,cameraPitch=-30,cameraTargetPosition=[0,0,0])
...
while True:
    ...
    for i in range(1,objects+1):
        ...
        angularVelocity.append(pb.getBaseVelocity(i)[1])
